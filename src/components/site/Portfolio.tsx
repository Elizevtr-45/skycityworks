...
const projects: Project[] = [
  ...
  },
  {
    ...
    area: "57 м²",
    description:
      "Ремонт под ключ в новостройке в тарифе «Стандарт». Спокойная современная палитра, встроенные системы хранения, аккуратная отделка и готовое пространство для комфортной жизни.",
    works: [
