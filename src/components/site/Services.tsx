    ...
    <section id="services" className="py-20 md:py-32 bg-background">
      <div className="container-px mx-auto max-w-7xl">
        <SectionHeader
          ...
          subtitle="Услуги ремонта квартир во Владивостоке, Артёме, Уссурийске и Находке. Капитальный, косметический и дизайнерский ремонт — от первого эскиза до сдачи под ключ."
        />
