...
const reviews = [
  { name: "Анна К.", role: "Снеговая Падь", text: "Сделали ремонт за 3 месяца, точно в срок и без единой доплаты. Всё, как обещали — даже лучше." },
  { name: "Дмитрий С.", role: "Эгершельд", text: "Профессиональная команда. Дизайн-проект полностью совпал с реальностью. Рекомендую без оговорок." },
