...
const projects: Project[] = [
  {
    ...
    area: "98 м²",
    description:
      "Ремонт под ключ в новостройке. Полный комплекс работ: от чернового состояния до заселения. Премиальные материалы, скрытые инженерные решения и индивидуальный дизайн.",
    works: [
  ...
  },
  {
    ...
    area: "57 м²",
    description:
      "Ремонт под ключ в новостройке в тарифе «Стандарт». Аккуратная геометрия стен, качественные материалы среднего сегмента и продуманная инженерия — готово к заселению.",
    works: [
      "Возведение и выравнивание перегородок",
      "Разводка электрики по дизайн-проекту",
      "Замена сантехники и разводка труб",
      "Стяжка пола, шумоизоляция",
      "Стены под покраску: штукатурка, шпаклёвка, финишная покраска",
  ...
  },
  {
    ...
    area: "40 м²",
    description:
      "Ремонт под ключ однокомнатной квартиры в новостройке. Тариф «Базовый»: всё необходимое для комфортного заселения — надёжно, аккуратно и по фиксированной смете.",
    works: [
