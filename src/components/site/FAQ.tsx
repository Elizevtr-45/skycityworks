...
const faqs = [
  ...
  },
  {
    ...
    a: "Стандартная гарантия — 2 года на все виды работ, прописана в договоре. Дополнительно действует расширенная гарантия: исправляем ошибки и недочёты, возникшие в процессе ремонта, за свой счёт. Если гарантийный срок прошёл, но недочёт — по нашей вине, придём и исправим.",
  },
  {
    q: "Изготавливаете ли вы мебель?",
    a: "Да. Производим корпусную мебель, кухни, гардеробные и встроенные шкафы на заказ. Единая концепция с ремонтом — от стен до фасадов.",
  },
  {
