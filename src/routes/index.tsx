  ...
  head: () => ({
    meta: [
      { title: "Ремонт квартир под ключ Владивосток — СКАЙСИТИ | 2800+ объектов" },
      {
        name: "description",
        content:
          "Ремонт квартир во Владивостоке без переплат. Эконом. Стандарт. Премиум. Цена фиксируется в договоре. Скидка 10% участникам СВО. Изделия из керамогранита. Кэшбэк 10%.",
      },
