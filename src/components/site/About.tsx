      ...
      <div className="container-px mx-auto max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <div className="reveal text-white/75 text-base md:text-lg leading-relaxed space-y-4">
            <p>
              СКАЙСИТИ — строительная компания полного цикла во Владивостоке и Приморском крае.
              Выполняем ремонт квартир под ключ: капитальный, косметический, дизайнерский,
              черновой и чистовой. Работаем по Владивостоку, Артёму, Уссурийску, Находке и
              всему Приморью.
            </p>
            <p>
              Делаем ремонт квартир в новостройках и на вторичке — от однокомнатных и студий
              до больших квартир в новых ЖК. Три пакета: эконом, стандарт, премиум — цена за
              квадратный метр фиксируется в договоре и не меняется по ходу работ.
            </p>
            <p>
              Параллельно с ремонтом изготавливаем мебель на заказ, столешницы из камня и
              изделия из керамогранита. Жилищное строительство, отделочные и
              ремонтно-строительные работы — всё одной бригадой, под персональным контролем.
            </p>
          </div>
        </div>
