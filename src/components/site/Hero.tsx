      ...
      <div className="relative container-px mx-auto max-w-7xl pt-28 pb-20 md:pt-32 md:pb-28">
        <div className="max-w-3xl reveal is-visible">
          ...
          <p className="mt-6 text-base sm:text-lg md:text-xl text-white/80 max-w-2xl leading-relaxed">
            {"Ремонт квартир во\u00A0Владивостоке без переплат — эконом, стандарт, премиум. Цена фиксируется в\u00A0договоре. Работаем с\u00A0новостройками и\u00A0вторичкой, делаем мебель на\u00A0заказ, изделия из\u00A0керамогранита. Скидка 10% участникам СВО, кэшбэк\u00A010%."}
          </p>
