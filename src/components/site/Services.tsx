    ...
    <section id="services" className="py-20 md:py-32 bg-background">
      <div className="container-px mx-auto max-w-7xl">
        <SectionHeader
          ...
          subtitle="Ремонт квартир во Владивостоке — в новостройках и на вторичке: ЖК «Айвазовский», «Восточный Луч», «Маринист», «Семь Ветров», «Da Vinci», «Аквамарин», «Чайка». Работаем во всех районах города: Первореченский, Ленинский, Фрунзенский, Советский, Первомайский — Эгершельд, Чуркин, Снеговая Падь, Патрокл, Седанка. Выезжаем в Артём, Уссурийск и Находку."
        />
