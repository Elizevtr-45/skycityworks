...
const projects: Project[] = [
  {
    ...
    type: "Владивосток · ЖК «Айвазовский» · 98 м²",
    price: "3 700 000 ₽",
    tier: "Премиум",
    duration: "3 месяца",
    area: "98 м²",
    description:
      "Ремонт под ключ в новостройке во Владивостоке, ЖК «Айвазовский» (Первореченский район). Полный комплекс работ: от чернового состояния до заселения. Премиальные материалы, скрытые инженерные решения и индивидуальный дизайн.",
    works: [
  ...
  },
  {
    ...
    type: "Владивосток · ЖК «Восточный Луч» · 57 м²",
    price: "1 750 000 ₽",
    tier: "Стандарт",
    duration: "3 месяца",
    area: "57 м²",
    description:
      "Ремонт под ключ в новостройке во Владивостоке, ЖК «Восточный Луч» (Ленинский район, Чуркин) в тарифе «Стандарт». Спокойная современная палитра, встроенные системы хранения, аккуратная отделка и готовое пространство для комфортной жизни.",
    works: [
  ...
  },
  {
    ...
    type: "Владивосток · ЖК «Маринист» · 1-комнатная · 40 м²",
    price: "1 100 000 ₽",
    tier: "Базовый",
    duration: "3 месяца",
    area: "40 м²",
    description:
      "Ремонт под ключ однокомнатной квартиры в новостройке во Владивостоке, ЖК «Маринист» (Снеговая Падь). Тариф «Базовый»: всё необходимое для комфортного заселения — надёжно, аккуратно и по фиксированной смете.",
    works: [
    ...
    <section id="portfolio" className="py-20 md:py-32 bg-dark">
      <div className="container-px mx-auto max-w-7xl">
        <SectionHeader
          ...
          subtitle="Реализованные проекты в новостройках Владивостока — ЖК «Айвазовский», «Восточный Луч», «Маринист», «Da Vinci», «Семь Ветров» — и в частных домах на Седанке, Патрокле, Эгершельде."
        />
          ...
          {projects.map((p, i) => (
            ...
            >
              ...
              <div className="absolute top-4 left-4 right-4 flex items-center justify-between gap-2 opacity-0 -translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500">
                ...
                <span className="px-3 py-1.5 rounded-full text-[10px] uppercase tracking-widest font-semibold glass text-white">
                  {p.area}
                </span>
              </div>
              ...
              <div className="absolute inset-x-0 bottom-0 p-6 md:p-8 translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                ...
                <div className="mt-4 flex items-center justify-between gap-3">
                  <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/10 backdrop-blur border border-white/15 text-white text-sm font-semibold tabular-nums">
